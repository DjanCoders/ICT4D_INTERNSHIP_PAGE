	...
	return (
		<div className="flex-1 py-4 relative cursor-pointer border-[2px] border-gray-400 rounded-lg  p-6 bg-white transition-all transform hover:-translate-y-2">
			...
			<button
				...
				type="button"
				className="absolute bottom-2 px-8 z-50 py-3 flex bg-gradient-to-r from-green-400 to-lime-100 text-black font-semibold rounded-lg shadow-md hover:from-lime-500 hover:to-lime-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 transition-transform hover:scale-105"
			>
				Apply Now
			</button>
		</div>
