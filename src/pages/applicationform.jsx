...
const ApplicationForm = () => {
  ...
  return (
    <div className="form-wrapper flex flex-col lg:flex-row items-center  gap-8">
      <div className="left-bar w-3/4 lg:w-[35%]">
        {/* Coder Image */}
      ...
      <div className="Apply-form w-[85%] lg:w-[50%] mx-auto md:mx-0 py-6 bg-stone-200">
        <h2 className="pb-3">
